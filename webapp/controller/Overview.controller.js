      ...
      "student28.sap.training.dynamicpage.controller.Overview",
      {
        ...
        onOpenViewSettings: function (oEvent) {
          ...
          if (!this._oViewSettingsDialog) {
            Fragment.load({
              name: "student28.sap.training.dynamicpage.view.ViewSettingsDialog",
              controller: this,
            }).then(
              function (oFragment) {
        ...
        onClear: function (oEvent) {
          ...
          for (var i = 0; i < oItems.length; i++) {
            var oControl = this.oFilterBar.determineControlByFilterItem(
              oItems[i]
            );
            if (oControl) {
              oControl.setValue("");
        ...
        filterTable: function (aCurrentFilterValues, bAnd) {
          this.getTableItems().filter(
            this.getFilters(aCurrentFilterValues, bAnd)
          );
        },
