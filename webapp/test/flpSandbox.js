		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dynamic Page",
									"targetURL": "#student28saptrainingdynamicpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student28saptrainingdynamicpage-display": {
								"semanticObject": "student28saptrainingdynamicpage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student28.sap.training.dynamicpage",
									"url": sap.ui.require.toUrl("student28/sap/training/dynamicpage")
								}
							}
						}
					}
